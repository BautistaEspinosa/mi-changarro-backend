 ...
 * sistema, como multiplicadores de sugerencia de precio, escala decimal, redondeo monetario y
 * valores base utilizados por más de un módulo.
 *
...
public final class BusinessConstants {
  ...
  /**
   * Escala decimal utilizada para operaciones monetarias.
   */
  public static final int DECIMAL_SCALE = 2;
  /**
   * Modo de redondeo utilizado en operaciones monetarias.
   */
