 ...
 *
 * <p>Cada instancia corresponde a un producto incluido dentro de una compra,
 * mostrando la información del producto, la cantidad adquirida, el costo
 * total pagado, el costo unitario calculado y las sugerencias de precio
 * de venta generadas por el sistema.
 *
 * <p>Las sugerencias de precio se calculan automáticamente utilizando los
 * multiplicadores definidos en {@code BusinessConstants} y no se almacenan
 * en la base de datos.
 *
