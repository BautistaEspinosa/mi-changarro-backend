...
public final class ProductoMessages {
  ...
  public static final String PRODUCTO_CREADO = "Producto creado correctamente.";
  ...
  public static final String PRODUCTOS_INACTIVOS_LISTADOS =
      "Productos inactivos obtenidos correctamente.";
  public static final String PRODUCTO_OBTENIDO = "Producto obtenido correctamente.";
  public static final String PRODUCTOS_LISTADOS = "Productos obtenidos correctamente.";
   ...
   * ==========================
   */
  public static final String PRODUCTO_INACTIVO = "El producto se encuentra inactivo.";
  public static final String PRODUCTO_DUPLICADO = "Ya existe un producto con ese nombre.";
  public static final String NOMBRE_REQUERIDO = "El nombre del producto es obligatorio.";
   ...
   * ==========================
   */
  public static final String STOCK_MINIMO_REQUERIDO = "El stock mínimo es obligatorio.";
